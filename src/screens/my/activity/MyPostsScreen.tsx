...
export const MyPostsScreen: React.FC = () => {
  ...
  const handleEditPost = (id: number) => {
    console.log('모집글 수정:', id);
    // TODO: 수정 화면으로 이동
  };

  const handleDeletePost = (id: number) => {
    console.log('모집글 삭제:', id);
    // TODO: 삭제 로직
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.statsCard}>
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{mockMyPosts.length}</Text>
            <Text style={styles.statLabel}>총 작성</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <Text style={styles.statValue}>
              {mockMyPosts.filter(p => p.status === 'recruiting').length}
            </Text>
          ...
          <View style={styles.statItem}>
            <Text style={styles.statValue}>
              {mockMyPosts.filter(p => p.status === 'completed').length}
            </Text>
