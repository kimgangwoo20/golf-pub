        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            ...
            <Text style={styles.bodyText}>
              골프 Pub(이하 "회사")은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
            </Text>
            <Text style={styles.bulletText}>• 회원 가입 및 관리: 회원제 서비스 이용에 따른 본인확인, 개인식별, 부정이용 방지</Text>
            <Text style={styles.bulletText}>• 서비스 제공: 골프장 부킹, 중고거래, 커뮤니티 서비스 제공</Text>
            <Text style={styles.bulletText}>• 마케팅 및 광고: 이벤트 및 광고성 정보 제공 (동의 시)</Text>

            <Text style={styles.sectionTitle}>2. 수집하는 개인정보 항목</Text>
            <Text style={styles.bodyText}>회사는 다음과 같은 개인정보 항목을 수집하고 있습니다.</Text>
            ...
            <Text style={styles.bodyText}>
              회원 탈퇴 시까지 보유하며, 관계법령에 의해 보존할 필요가 있는 경우 해당 법령에서 정한 기간 동안 보존합니다.
            </Text>
            ...
            <Text style={styles.bodyText}>
              회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 이용자가 사전에 동의한 경우 또는 법률에 특별한 규정이 있는 경우에는 예외로 합니다.
            </Text>
