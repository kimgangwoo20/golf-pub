        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            ...
            <Text style={styles.bodyText}>
              이 약관은 골프 Pub(이하 "회사")이 제공하는 모바일 애플리케이션 서비스(이하 "서비스")의 이용조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
            </Text>

            <Text style={styles.sectionTitle}>제2조 (정의)</Text>
            <Text style={styles.bulletText}>① "서비스"란 회사가 제공하는 골프 부킹, 중고거래, 커뮤니티 등 모든 서비스를 의미합니다.</Text>
            <Text style={styles.bulletText}>② "회원"이란 서비스에 가입하여 이용계약을 체결한 자를 말합니다.</Text>
            <Text style={styles.bulletText}>③ "포인트"란 서비스 내에서 사용 가능한 가상 화폐를 의미합니다.</Text>
            ...
            <Text style={styles.bodyText}>
              ...
              ② 회원은 타인의 개인정보를 침해하거나 허위 정보를 등록하여서는 안 됩니다.{'\n'}
              ③ 회원은 서비스를 이용하여 불법 행위를 하여서는 안 됩니다.
            </Text>

            <Text style={styles.sectionTitle}>제6조 (서비스 이용의 제한)</Text>
            <Text style={styles.bodyText}>
              회사는 회원이 약관을 위반하거나 서비스의 정상적인 운영을 방해한 경우, 서비스 이용을 제한하거나 회원자격을 상실시킬 수 있습니다.
            </Text>
